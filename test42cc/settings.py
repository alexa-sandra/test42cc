...
ADMIN_MEDIA_PREFIX = 'admin_tools/static/admin_tools/'
...
MIDDLEWARE_CLASSES = (
    ...
    'test42cc.person.middleware.HttpStoredQueryMiddleware',
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'test42cc.person.context_processors.SettingsToContext',
)
...
TEMPLATE_DIRS = (
    ...
    #os.path.join(PROJECT_ROOT, 'env/lib/python2.6/site-packages/easymode/templates'),
)
