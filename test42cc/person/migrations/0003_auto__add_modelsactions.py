...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'person_modelsactions', (
        ...
        db.send_create_signal(u'person', ['ModelsActions'])


    def backwards(self, orm):
        # Deleting model 'ModelsActions'
        db.delete_table(u'person_modelsactions')
